      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-muted/50 border border-border">
            ...
            <span className="text-xs font-medium text-muted-foreground">{onlineUsers.length}</span>
          </div>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="p-3 max-w-[280px]">
          <p className="text-xs font-semibold mb-2">Active Users ({onlineUsers.length})</p>
